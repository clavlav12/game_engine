...
source = effect.CreateSource((0, 0), initspeed=2.0, initdirection=math.pi, initspeedrandrange=1.0, initdirectionrandrange=math.pi,
                             particlesperframe=20, particlelife=80, drawtype=PyIgnition.DRAWTYPE_CIRCLE, colour=(100, 100, 250), radius=10.0)
...
rect1 = effect.CreateRectangle((500, 450), colour=(
    100, 200, 200), width=250.0, height=100.0, bounce=0.2)
...
line = effect.CreateBoundaryLine((700, 500), colour=(
    0, 0, 0), bounce=0.1, normal=[-1.4142, -1.4142])
line.CreateKeyframe(300, normal=[-2, -1])
line.CreateKeyframe(500, normal=[-1, 0])
line2 = effect.CreateBoundaryLine(
    (0, 600), colour=(0, 0, 0), bounce=0.1, normal=[0, -1])
line3 = effect.CreateBoundaryLine(
    (0, 600), colour=(0, 0, 0), bounce=0.1, normal=[1, 0])

...
class CollisionManifold:
    ...
    def collision_response(self, obj1, obj2):
        ...
        if not (obj1.inv_mass + obj2.inv_mass + imp_aug1 + imp_aug2):
            return
        impulse = vel_sep_diff / (obj1.inv_mass + obj2.inv_mass + imp_aug1 + imp_aug2)
...
class AdvancedRigidBody(base_sprites.BaseRigidBody):
    def __init__(self, mass, moment_of_inertia, orientation, components: List[Bodies.Body],
        ...
        super(AdvancedRigidBody, self).__init__(self.get_rect(), mass, moment_of_inertia, orientation, control)
...
class Wall(AdvancedRigidBody):
    ...
    def collision(self, other, collision):
        if isinstance(other, Wall):
            ...
            return super(Wall, self).collision(other, collision)
